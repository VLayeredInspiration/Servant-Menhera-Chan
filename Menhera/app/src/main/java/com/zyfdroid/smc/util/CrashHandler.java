...
public class CrashHandler implements UncaughtExceptionHandler {  
	    ...
	    public static final String TAG = "ManheraCrashHandler";  
		...
		String logs="";
		        ...
		        //保存日志文件   
				if(!savedFile){
		      logs=  saveCrashInfo2File(ex);  
				savedFile=true;
				}
			if (ex == null) {  
				logs=logs +"Caused by C exception.See logcat.";  
			}  
	    ...
	    private String saveCrashInfo2File(Throwable ex) {  
			...
			sb.append("\n[Log]\n").append(Klog.log);
		        try {  
			            ...
			            String fileName = "crash-"+"com.semssjbcs.servantmanhera-" + timestamp + ".log";  
